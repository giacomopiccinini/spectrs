...
fn viridis(t: f32) -> [u8; 3] {
    ...
    let g = (0.004975
        + t * (0.408503
            + t * (2.820819
                + t * (-11.188263 + t * (14.949977 + t * (-9.419796 + t * 2.192326))))));
    let b = (0.329415
...
fn magma(t: f32) -> [u8; 3] {
    ...
    let g = (0.001512
        + t * (0.142844
            + t * (2.433026
                + t * (-9.125778 + t * (13.268850 + t * (-10.347974 + t * 2.848073))))));
    let b = (0.013952
...
fn inferno(t: f32) -> [u8; 3] {
    let r = (0.001788
        + t * (0.200942
            + t * (3.526908
                + t * (-11.642545 + t * (17.366990 + t * (-12.351348 + t * 3.914439))))));
    let g = (0.000262
        + t * (0.034534
            + t * (2.445295
                + t * (-9.520904 + t * (14.683786 + t * (-11.257943 + t * 3.114629))))));
    let b = (0.014227
        + t * (1.534345 + t * (-5.444980 + t * (11.756179 + t * (-14.117606 + t * 6.258159)))));
...
fn plasma(t: f32) -> [u8; 3] {
    ...
    let g = (0.029803
        + t * (0.237302
            + t * (2.524446
                + t * (-9.892820 + t * (14.450550 + t * (-10.611676 + t * 2.963018))))));
    let b = (0.527975
